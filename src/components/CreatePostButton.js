...
export class CreatePostButton extends React.Component {
    state = {
        visible: false, // 控制对话框弹出
        confirmLoading: false, // 按钮的loading效果
    }
    showModal = () => {
        this.setState({
            visible: true,
    ...
    handleOk = () => {
        this.setState({ confirmLoading: true }); // 开始loading
        this.form.validateFields((err, values) => { // form是经过enhance的CreatePostForm，通过ref获得
            if (!err) {
    ...
    saveFormRef = (form) => { //ref 获取类的instance
        this.form = form;
    }
    render() {
